...
> **Storage driver — activated on every code change.**

Code quality constraints: file size limits, type safety, pure logic extraction, and universal prohibitions.
...
Project-specific prohibitions derived from production incidents. Stage 3.6 proposes additions via `proposed-rules.md`. Format:
